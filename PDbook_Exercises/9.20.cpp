/*
(SavingsAccount Class) Create a SavingsAccount class. Use a static data member annualInterestRate
to store the annual interest rate for each of the savers. Each member of the class contains a
...
private:
    static unsigned int annualInterestRate;
    unsigned int savingsBalance;

public:
    unsigned int calculateMonthlyInterest();
    static unsigned int modifyInterestRate();
};
